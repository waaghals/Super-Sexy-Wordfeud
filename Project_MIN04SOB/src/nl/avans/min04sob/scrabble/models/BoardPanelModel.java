...
public class BoardPanelModel extends CoreModel {
	...
	public BoardPanelModel() {
		...
		playerTile = new TileModel[][] { { new TileModel("T"),
				new TileModel("T"), new TileModel("T"), new TileModel("T"),
				new TileModel("T"), new TileModel("T") } };
		tileData = new TileModel[][] {
				{
						// 1
						new TileModel("row1"), new TileTW(), new TileModel(""),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileTW(),
						new TileModel(""), new TileModel(""),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileTW() },
				{
						// 2
						new TileModel("row2"), new TileModel(""), new TileDW(),
						new TileModel(""), new TileModel(""),
				...
				{
						// 3
						new TileModel("row3"), new TileModel(""),
						new TileModel(""), new TileDW(), new TileModel(""),
...

				{
						...
						// 4
						new TileModel("row4"), new TileDL(), new TileModel(""),
						new TileModel(""), new TileDW(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDL(),
						new TileModel(""), new TileModel(""),
						new TileModel(""), new TileDW(), new TileModel(""),
						new TileModel(""), new TileDL(), },

				{
						// 5
						new TileModel("row5"), new TileModel(""),
						new TileModel(""), new TileModel(""),
						new TileModel(""), new TileDW(), new TileModel(""),
						new TileModel(""), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDL(),
				...
				{
						// 6
						new TileModel("row6"), new TileModel(""), new TileTL(),
						new TileModel(""), new TileModel(""),
						new TileModel(""), new TileTL(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileTL(),
						new TileModel(""), new TileModel(""),
				...
				{
						// 7
						new TileModel("row7"), new TileModel(""),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDL(),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDL(),
				...
				{
						// 8
						new TileModel("row8"), new TileTW(), new TileModel(""),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileStart(),
						new TileModel(""), new TileModel(""),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileTW(), },
				...
				{
						// 9
						new TileModel("row9"), new TileModel(""),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDL(),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDL(),
				...
				{
						// 10
						new TileModel("row10"), new TileModel(""),
				...
				{
						// 11
						new TileModel("row11"), new TileModel(""),
						new TileModel(""), new TileModel(""),
						new TileModel(""), new TileDW(), new TileModel(""),
						new TileModel(""), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDL(),
				...
				{
						// 12
						new TileModel("row12"), new TileDL(),
						new TileModel(""), new TileModel(""), new TileDW(),
						new TileModel(""), new TileModel(""),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDW(),
				...
				{
						// 13
						new TileModel("row13"), new TileModel(""),
						new TileModel(""), new TileDW(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDL(),
						new TileModel(""), new TileDL(), new TileModel(""),
						new TileModel(""), new TileModel(""), new TileDW(),
				...
				{
						// 14
						new TileModel("row14"), new TileModel(""),
				...
				{
						// 15
						new TileModel("row15"), new TileTW(),
						new TileModel(""), new TileModel(""), new TileDL(),
						new TileModel(""), new TileModel(""),
		...
		/*
		 * String dataValues[][] = { { "", tl.getLetter(), tl.getLetter(), "",
		 * "DL", "", "", "", "TW", "", "", "", "", "", "", "TW" }, { "2", "",
		 * "DW", "", "", "", "TL", "", "", "", "TL", "", "", "", "DW", "" }, {
		 * "3", "", "", "DW", "", "", "", "DL", "", "DL", "", "", "", "DW", "",
		 * "" }, { "4", "DL", "", "", "DW", "", "", "", "DL", "", "", "", "DW",
